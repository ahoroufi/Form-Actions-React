...
import { isEmail, isNotEmpty, hasMinLength, isEqualToOtherValue } from '../util/validation'
  ...
  function signupAction(preFormState, formData) {
    ...
    if (acquisitionChannel.length === 0) {
      errors.push('Please select at least one aquistion channel.');
    }
  ...
  return (
    <form action={formAction}>
      ...
      <div className="control-row">
        ...
        <div className="control">
          <label htmlFor="confirm-password" defaultValue={formState.enteredValues?.confirmPassword}>Confirm Password</label>
          <input
            id="confirm-password"
            type="password"
      ...
      <fieldset>
        ...
        <div className="control" defaultValue={formState.enteredValues?.lastName}>
          <input
            type="checkbox"
            id="google"
            name="acquisition"
